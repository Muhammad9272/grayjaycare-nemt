  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-xl border border-border bg-card p-5 shadow-sm">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-semibold">New phone booking</h2>
      ...
      <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input type="number" min={0} className={inputClass} value={waitMinutes} onChange={(e) => setWaitMinutes(e.target.value)} />
        </div>
        <div>
