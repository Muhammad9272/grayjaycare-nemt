...
export default async function DispatchPage({ searchParams }: { searchParams: Promise<{ booked?: string }> }) {
  ...
  const serialized = trips.map((t) => ({
    ...
    pickupFacilityName: t.pickupFacilityName,
    pickupDepartment: t.pickupDepartment,
    pickupRoom: t.pickupRoom,
    dropoffAddress: t.dropoffAddress,
    dropoffFacilityName: t.dropoffFacilityName,
    ...
    oxygenRequirement: t.oxygenRequirement,
    oxygenLitresPerMinute: t.oxygenLitresPerMinute ? Number(t.oxygenLitresPerMinute) : null,
    isolationRequirement: t.isolationRequirement,
    isolationDetails: t.isolationDetails,
    dnrRequirement: t.dnrRequirement,
    specialAssistance: t.specialAssistance,
    patientOver250: t.patientOver250,
    dnrDocumentationConfirmed: t.dnrDocumentationConfirmed,
    hasBelongings: t.hasBelongings,
    belongingsDescription: t.belongingsDescription,
    driverId: t.driverId,
